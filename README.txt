...
:cracker => :Extreme (10 billion attempts/sec), :GPU (3 billion), :desktop (200 million), online (100)

:speed => any positive integer

:user_gen => true/false (sets whether or not to correct for predictability of user-generated passwords by 4x decrease in password strength)